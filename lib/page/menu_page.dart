...
import 'package:eight_app/modal/sair_modal.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              MenuButton(
                callback: () => context.goNamed(RouteEnum.PERFIL.value,
              ...
              MenuButton(
                callback: () => context.goNamed(RouteEnum.EDITAR_PERFIL.value,
                    pathParameters: {'idUsuario': widget._idUsuario}),
              ...
              const SizedBox(height: 8),
              MenuButton(
                callback: () => context.goNamed(RouteEnum.NOTIFICACAO.value,
                    pathParameters: {'idUsuario': widget._idUsuario}),
              ...
              const SizedBox(height: 8),
              MenuButton(
                callback: () => context.goNamed(RouteEnum.ATIVIDADE.value,
                    pathParameters: {'idUsuario': widget._idUsuario}),
                subtitulo: ATIVIDADE,
