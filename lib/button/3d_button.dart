...
class Button3dStyle {
  ...
  static const RED =
      Button3dStyle(topColor: Color(0xFFc62f2f), backColor: Color(0xFF922525));
  static const BLUE =
      Button3dStyle(topColor: Color(0xFF25a09c), backColor: Color(0xFF197572));
  static const WHITE =
      Button3dStyle(topColor: Color(0xFFffffff), backColor: Color(0xFFCFD8DC));
}
